...
# Api
java_import 'btripoloni.rubycore.api.RubyCoreApi'
# Minecraft imports
...
java_import 'net.minecraft.client.Minecraft'
java_import 'net.minecraft.init.Items'
java_import 'net.minecraft.item.ItemStack'
java_import 'net.minecraft.item.Item'
java_import 'net.minecraft.world.World'
java_import 'net.minecraft.world.chunk.IChunkProvider'
java_import 'net.minecraft.world.gen.feature.WorldGenMinable'
